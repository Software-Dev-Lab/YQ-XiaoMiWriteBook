import { type IResponse } from '../../../src/api/type/index'
import requestInstance from '../../../src/api/index'
/**
 * 响应数据
 */
export type IDetailDataType = {
    /**
     * 文章id
     */
    art_id: string
...
export function fetchDetailAPI(id: string) {
    return requestInstance.request<IResponse<IDetailDataType>>({
        url: `/articles/${id}`,
    })
}